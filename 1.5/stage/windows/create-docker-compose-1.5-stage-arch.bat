...
echo     image: public.ecr.aws/r5d0x2q7/causewaygui:1.5-stage>>docker-compose.yml
...
echo     image: public.ecr.aws/r5d0x2q7/causewayapi:1.5-stage>>docker-compose.yml
